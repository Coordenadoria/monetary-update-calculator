...
const igpmAcumulado1 = (fator1 - 1) * 100;
console.log('Fator ciclo 1 (2020):', fator1.toFixed(10));
console.log('IGP-M acumulado ciclo 1:', igpmAcumulado1.toFixed(4), '%');
...
console.log('Valor da parcela ciclo 1 (1-12):', valorParcela1.toFixed(2));
...
const igpmAcumulado2 = (fator2 - 1) * 100;
console.log('\nFator ciclo 2 (2021):', fator2.toFixed(10));
console.log('IGP-M acumulado ciclo 2:', igpmAcumulado2.toFixed(4), '%');
...
console.log('Valor da parcela ciclo 2 (13-24):', valorParcela2.toFixed(2));
...
// Verificar a diferença esperada
console.log('\nDiferença entre parcelas (esperado ~2.986%):');
console.log('Reajuste real:', ((valorParcela2 / valorParcela1 - 1) * 100).toFixed(4), '%');
